...
if __name__ == "__main__":
	...
	for i in range(_config.nepoch):
		...
		# if not _config.use_modified_LSTMCell:
		# 	print('using original LSTMCell time it takes:', end_time-start_time)
		# else:
		# 	print('using modified LSTMCell time it takes:', end_time-start_time)
		#
		# if not _config.use_f1:
		# 	print('using original f1 time it takes:', end_time-start_time)
		# else:
		# 	print('using modified f1 time it takes:', end_time-start_time)

		if not _config.use_char_embedding:
			print('using original char embedding time it takes:', end_time-start_time)
		else:
			print('using modified char embedding time it takes:', end_time-start_time)